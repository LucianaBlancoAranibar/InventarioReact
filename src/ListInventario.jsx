        ...
        <tbody>
          {inventarios.map((inventario) => (
            <tr key={inventario.inventarioId}>
              ...
              <td className="border px-4 py-2">{inventario.nombreProducto}</td>
              <td className="border px-4 py-2">{inventario.nombreUbicacion}</td>
              <td className="border px-4 py-2">{inventario.cantidad}</td>
              <td className="border px-4 py-2">
                <button onClick={() => handleDelete(inventario.inventarioId)}>
                  Eliminar
                </button>
              </td>
            </tr>
